  ...
  return (
    <div className='  m-2 md:m-6 bg-slate-50'>
      ...
      <div className='flex gap-2  flex-col'>
        <div className='flex flex-row gap-6 md:justify-between'>
          <div className='flex gap-1 md:gap-20 '>
            ...
            <div className='flex flex-row mt-3 '>
              <i className='fa fa-search mt-2 mx-1 md:mx-4  text-slate-400'></i>
              ...
              />
              <i className='fa fa-camera mt-2 -mx-5 text-slate-400 z-50'></i>
            </div>
          </div>
          <div className='flex flex-row gap-1 md:gap-6'>
            <span className='mt-4'>
              <i className='fa fa-usd md:text-2xl text-slate-300'></i>
            </span>
            <span className='mt-4'>
            ...
            <Link href={"/profile"} className='w-10 mt-3 md:mt-auto'>
              <Image
                ...
                width={50}
                height={40}
                className='rounded-full rounded-image  ring-1 ring-slate-400 md:-pb-2'
              />
            </Link>
          </div>
        </div>

        <div className='flex flex-col px-2 md:px-20 pt-6 gap-3  bg-slate-200 rounded-xl relative'>
          <span className='font-bold text-md'>top relevant product </span>

          <div className='flex flex-col flex-wrap overflow-x-scroll justify-normal h-96 gap-4 md:gap-16 pb-5 pt-3'>
            {[1, 2, 3, 4, 5, 6, 7].map((movie) => (
              <div
                key={movie}
                className='flex flex-col w-full md:w-1/3 h-full relative'
              >
          ...
          <div className='absolute top-0 right-0 z-50 flex flex-col gap-2 w-36 md:w-72 mt-10 md:mt-6 bg-blue-400 p-2 md:p-8  rounded-l-3xl text-black'>
        ...
        <div className='flex m-10 md:m-20 flex-row text-slate-400 font-bold text-2xl justify-between gap-10'>
        ...
        <div className='flex overflow-auto w-full flex-row m-2 md:m-8 gap-3 md:gap-10'>
          <div className=' flex flex-col md:w-1/3 bg-blue-400 text-white p-3 md:p-6 h-72 z-10 gap-6 md:gap-20  rounded-r-3xl'>
          ...
          <div className='flex flex-row gap-10 md:-mx-72'>
            <span className='flex  flex-col md:w-96 gap-2 z-50 shadow-md rounded-2xl mt-3 h-64 bg-white '>
              <span className='text-xl p-3 font-bold'>
                lowest prices in 90 days{" "}
              </span>
              <div className='flex flex-row gap-3 md:gap-10 px-1'>
        ...
        {/* step 3 */}
        <div className='flex flex-col md:flex-row text-black m-3 w-full gap-4 md:gap-16 justify-normal mt-10'>
        ...
        {/* step4 */}
        <div className='flex m-3 md:m-20 flex-row text-slate-400 font-bold text-2xl justify-between gap-10'>
          <div className='flex flex-row gap-3'>
            <i className='fa fa-star  text-yellow-400 rounded-full bg-blue-400 p-2'></i>
            products
          </div>
        ...
        {/* step5 */}
        <div className='flex m-2 md:m-10 flex-row text-slate-400 font-bold text-xs md:text-2xl justify-between gap-2'>
          <div className='md:w-96'>Consumer Electronics </div>
        ...
        <div className='flex flex-col md:flex-row h-72 md:h-auto overflow-scroll  md:mx-8 px-2 md:px-8  w-auto'>
          ...
          <div className='flex flex-col gap-5 w-full border-b-4 md:border-b-0 md:border-r-4  px-1'>
        ...
        {/* step6 */}
        <div className='flex md:m-10 flex-row text-slate-400 font-bold text-sm md:text-2xl justify-between gap-10'>
          <div className='md:w-96'>Apparel </div>
          <span className='px-8 ring-1 ring-slate-400 rounded-full w-full bg-slate-300 h-2 mt-4'></span>
        </div>
        <div className='flex flex-col md:flex-row h-72 md:h-auto overflow-scroll  md:mx-8 px-2 md:px-8  w-auto'>
          <div className='flex flex-col gap-5 border-b-4 md:border-b-0 w-full border-r-4 px-1 bg-green-300'>
            <div className='flex justify-center my-3 md:mt-20'>
              <div className='flex  w-32  h-32 py-2 rounded-lg  relative'>
                <Image
                  src={"/shirt.jpg"}
