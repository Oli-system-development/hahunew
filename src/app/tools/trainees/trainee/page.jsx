...
const Trainees = () => {
  ...
  if (trainee) {
    return <Tutition trainee={ trainee} />;
  }
          ...
          <div className='flex flex-col md:flex-row md:justify-between w-full md:px-20  text-md font-thin text-slate-500 md:m-3 gap-2 '>
            ...
            <div className='flex justify-around gap-2 md:gap-16'>
              <i
                ...
                className={`${
                  view
                    ? "fa fa-tag mt-2  text-yellow-700 bg-slate-100 ring-1 ring-yellow-500 rounded-full px-1  text-lg md:text-2xl py-1 "
                    : "fa fa-pause mt-2  text-blue-700 bg-slate-100 ring-1 ring-yellow-500 rounded-full px-2  text-lg md:text-2xl py-1 "
                }`}
              ></i>
                ...
                <tbody>
                  <tr className='text-sm font-thin text-slate-500'>
                    {[
                      ...
                      !view && "tuition status",
                      !view && "GPA",
                      !view && "department review status",
                      !view && "register review action",
                    ].map((tab, index) => (
                      <th key={index}>{tab}</th>
                    ))}
                  </tr>
                  ...
                  {trainees?.map((trainee, index) => (
                    <tr key={trainee.userId} className='text-sm text-gray-900'>
                      <td
                  ...
                  <div className='flex flex-row justify-around shadow-xl w-full bg-white'>
                    <div className='flex flex-row justify-center w-full bg-slate-300 gap-0 rounded-md'>
                      ...
                      <div className='flex flex-col gap-2 md:gap-5 pt-10 md:pt-16 md:pr-3 md:pl-10 text-xs md:text-base  md:text-left '>
                        ...
                        <span>
                          <i className='fa fa-message md:px-2'></i>
                          hana@gmail.com
                        </span>
                      </div>
                    </div>
